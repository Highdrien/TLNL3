...
def train_word_embeddings(text, embedding_size, k, window_size,learning_rate):
    ...
    for iteration in range(k):
        ...
        for target_word_index, target_word in enumerate(text):
...
window_size = 3  # Taille de la fenêtre centrée (ajustez selon vos besoins)
learning_rate = 0.01  # Taux d'apprentissage (ajustez selon vos besoins)
