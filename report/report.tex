...
%Les a-t-on obtenu ? faire la comparaison ici avec les resultats du modele précedent.
...
% écrire la conclusion + pistes d'améliorations ? trouver longeur optimal du nombre de mots ?
...
%         \hline
%         modèles & \textbf{FROZEN} & \textbf{SCRATCH} & \textbf{ADAPT} \\
%         \hline
%         temps (en s) & 360 & 1001 & 460 \\
%          \hline
%     \end{tabular}
%     \caption{Comparaison du temps d'entraînement des différents modèles sur 10 epochs.}
%     \label{tab:times}
% \end{table}
